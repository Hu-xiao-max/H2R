...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='pose', choices=['all', 'ego', 'pose'],
                        help = 'Download all views, an egocentric view, or only poses')
    parser.add_argument('--dest', type=str,help = 'Destination path to download files.', default='dataset')
    parser.add_argument('--username', type=str, default='70397', help = 'id from https://h2odataset.ethz.ch/', required=True)
    parser.add_argument('--password', type=str, default='02dfd443', help = 'password from https://h2odataset.ethz.ch/',required=True)
